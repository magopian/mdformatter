...
This is copied verbatim from <https://github.com/Gizra/elm-keyboard-event/blob/master/examples/Window/Events.elm>
See the example here: <https://gizra.github.io/elm-keyboard-event/Window.html>
