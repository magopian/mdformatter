...
Use case: when creating an ebook from a paper book, there's several steps:

1. scan the pages
2. use an OCR application to recognize the text
3. format the recognized raw text as markdown to add titles, paragraphs, footnotes, fix typos...
4. use pandoc to convert from markdown to epub
